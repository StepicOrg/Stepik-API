...
All API examples are up to date and working if the build status is `passed`: [![Build Status](https://travis-ci.org/StepicOrg/Stepic-API.svg?branch=master)](https://travis-ci.org/StepicOrg/Stepic-API)
